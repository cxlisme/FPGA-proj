...
#
# Generated by export_simulation on Wed Jan 12 15:23:12 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './B_conv2.sh' script.

./B_conv2.sh -reset_run
...
./B_conv2.sh -noclean_files

For more information on the script, please type './B_conv2.sh -help'.
