...
#
# Generated by export_simulation on Wed Jan 12 15:22:43 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './B_conv1.sh' script.

./B_conv1.sh -reset_run
...
./B_conv1.sh -noclean_files

For more information on the script, please type './B_conv1.sh -help'.
