...
#
# Generated by export_simulation on Wed Jan 12 15:25:34 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './W_conv2.sh' script.

./W_conv2.sh -reset_run
...
./W_conv2.sh -noclean_files

For more information on the script, please type './W_conv2.sh -help'.
