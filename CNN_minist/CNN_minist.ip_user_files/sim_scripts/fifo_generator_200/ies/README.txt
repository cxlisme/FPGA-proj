...
#
# Generated by export_simulation on Mon Jan 10 14:41:17 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './fifo_generator_200.sh' script.

./fifo_generator_200.sh -reset_run
...
./fifo_generator_200.sh -noclean_files

For more information on the script, please type './fifo_generator_200.sh -help'.
