...
#
# Generated by export_simulation on Wed Jan 05 20:50:45 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './feature_ram.sh' script.

./feature_ram.sh -reset_run
...
./feature_ram.sh -noclean_files

For more information on the script, please type './feature_ram.sh -help'.
