...
#
# Generated by export_simulation on Wed Jan 12 15:26:52 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './W_fc1.sh' script.
...
./W_fc1.sh -noclean_files

For more information on the script, please type './W_fc1.sh -help'.
