...
HD_PWD='D:/DATA/vivado_project/0TEST/minist_cnn/minist_cnn/minist_cnn.runs/fifo_generator_200_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_generator_200.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_generator_200.tcl
