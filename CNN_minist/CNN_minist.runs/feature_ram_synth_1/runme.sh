...
HD_PWD='D:/DATA/vivado_project/0TEST/minist_cnn/minist_cnn/minist_cnn.runs/feature_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log feature_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source feature_ram.tcl
